(function () {
  ...
  function planningDropPlacementFromPreview(bookingId, day) {
    ...
    return { ...planningDropPreview, exactTimeDrop: true, fromDragPreview: true };
  }
  ...
  el.planningBoard.addEventListener("drop", async (event) => {
    ...
    event.preventDefault();
    const placement = planningDropPlacementFromPreview(bookingId, day) || planningDropPlacement(event, bookingId, day);
    clearPlanningDropUi();
    try {
