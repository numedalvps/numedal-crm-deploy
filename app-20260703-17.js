(function () {
  ...
  el.leadDetail?.addEventListener("click", (event) => {
    ...
    if (linkCustomer) {
      runBusyButton(linkCustomer, () => linkLeadToExistingCustomer(linkCustomer.dataset.linkLeadCustomer, linkCustomer.dataset.linkExistingCustomer), "Klarte ikke koble lead til kundekort.");
      return;
    }
