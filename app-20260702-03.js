(function () {
  ...
  const heatPumpOfferItems = [
    { id: "panasonic_hz25_flagship_white", brand: "Panasonic", label: "HZ25 Flagship Hvit 7.5kw", unit: "stk", price: 23990, defaultQty: 1, kind: "heatpump" },
    { id: "panasonic_hz25_flagship_graphite", brand: "Panasonic", label: "HZ25 Flagship Graphite Grey 7.5kw", unit: "stk", price: 25590, defaultQty: 1, kind: "heatpump" },
    { id: "panasonic_nz25_etherea_eco", brand: "Panasonic", label: "NZ25 Etherea Eco 6.5kw", unit: "stk", price: 19990, defaultQty: 1, kind: "heatpump" },
    { id: "panasonic_z25_floor", brand: "Panasonic", label: "Z25 Gulvmodell", unit: "stk", price: 24990, defaultQty: 1, kind: "heatpump" },
    { id: "fujitsu_norgespumpa_57_black", brand: "Fujitsu", label: "Norgespumpa 5.7 Dempet Sort", unit: "stk", price: 23990, defaultQty: 1, kind: "heatpump" },
    { id: "fujitsu_norgespumpa_59_black_25990", brand: "Fujitsu", label: "Norgespumpa 5.9 Dempet Sort", unit: "stk", price: 25990, defaultQty: 1, kind: "heatpump" },
    { id: "fujitsu_norgespumpa_59_black_29990", brand: "Fujitsu", label: "Norgespumpa 5.9 Dempet Sort", unit: "stk", price: 29990, defaultQty: 1, kind: "heatpump" },
    { id: "fujitsu_extreme_floor_55", brand: "Fujitsu", label: "Extreme Gulv 5.5", unit: "stk", price: 24990, defaultQty: 1, kind: "heatpump" },
    { id: "toshiba_signature_25", brand: "Toshiba", label: "Signature 25", unit: "stk", price: 26990, defaultQty: 1, kind: "heatpump" },
    { id: "toshiba_signature_35", brand: "Toshiba", label: "Signature 35", unit: "stk", price: 29490, defaultQty: 1, kind: "heatpump" },
    { id: "toshiba_seiya_nordic_25", brand: "Toshiba", label: "Seiya Nordic 25", unit: "stk", price: 16990, defaultQty: 1, kind: "heatpump" },
    { id: "toshiba_seiya_nordic_35", brand: "Toshiba", label: "Seiya Nordic 35", unit: "stk", price: 17990, defaultQty: 1, kind: "heatpump" },
  ];
  const jobPriceItems = [
    { id: "standard_installation", label: "Standard montering", unit: "stk", price: 7490, defaultQty: 1 },
  ...
  function offerLinePresetOptions(selected = "heatpump_custom") {
    ...
    const heatPumps = heatPumpOfferItems.map((item) => offerLineOptionHtml(item, selected)).join("");
    const additions = jobPriceItems.map((item) => offerLineOptionHtml(item, selected)).join("");
    return [
      custom,
  ...
  function completionOptions(type) {
    ...
    if (type === "befaring") {
      return [
        ...
        ["book_installation", "Book installasjon nå"],
        ["none", "Ingen neste steg nå"],
      ];
    }
  ...
  function openCompletedLeadFollowup(customer, lead, status) {
    ...
    setSyncStatus(
      status === "needs_offer"
        ...
        : "Befaring fullført. Saken ligger i oppfølging.",
      "ok",
    );
    return true;
  }
