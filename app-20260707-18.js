(function () {
  ...
  async function setLeadInactive(customerId) {
    ...
    const ok = await askForConfirmation({
      title: "Skjul sak",
      message: "Skjule denne gamle saksmarkeringen fra innboksen? Kundekortet beholdes.",
  ...
  function planningDropPlacementForDrop(event, bookingId, day) {
    ...
    return planningDropPlacement(event, bookingId, day);
  }
