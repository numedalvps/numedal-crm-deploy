(function () {
  ...
  function leadReadinessHtml(entry, customer, realCustomer, status) {
    ...
    const summary = missing.length
      ? `Mangler: ${missing.map((item) => item.label.toLowerCase()).join(", ")}`
      : "Klar for neste steg";
    return `
      ...
      <section class="detail-section lead-offer-section">
        ...
        <div class="lead-offer-builder">
          ...
          <div class="lead-offer-line-grid">
            ...
            <button class="secondary" data-add-offer-line="${escapeHtml(target)}" type="button" title="Legger valgt eller egen linje i listen. Kontroller teksten før du sender tilbudet.">Legg til valgt/egen</button>
          </div>
