      ...
      <div class="intake-inbox-list">
        ${rows.slice(0, 8).map((row) => {
          ...
          <article class="${active ? "active" : ""}">
            ...
            <div class="mini-action-row">
              <button class="${active ? "order-primary" : ""}" data-load-intake="${escapeHtml(row.id)}" type="button" title="${active ? "Utkastet er åpnet i Hurtigregistrering over listen." : "Åpne utkastet i Hurtigregistrering for kontroll og lagring."}">${active ? "Åpnet" : "Behandle"}</button>
