(function () {
  ...
  function installHelpText() {
    const help = [
      ...
      ['[data-new-action="paste"]', "Gå til Innboks og lim inn en ny melding eller henvendelse."],
      ...
      ["#formIsCustomer", "Huk av når personen faktisk er kunde. Henvendelser fra innboks starter normalt som ikke kunde."],
  ...
  function leadCustomerMatchHtml(entry) {
    ...
    return `
      <details class="detail-section attention compact-warning lead-match-notice">
        ...
        <p>Åpne bare hvis du vil sjekke om henvendelsen skal kobles til et eksisterende kundekort.</p>
