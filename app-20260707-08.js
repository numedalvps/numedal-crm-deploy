  ...
  function orderDetailActionsHtml(order, customer, primaryBooking, effectiveBilling, linkedJob) {
    ...
    if (primaryBooking) {
      ...
      if (done && canHavePriceBasis) {
        ...
        more.push(`<button data-copy-billing-draft="${escapeHtml(primaryBooking.id)}" type="button" title="Kopier fakturagrunnlag med kunde, adresse, varelinjer, sum og CRM-id til eAccounting.">Kopier fakturagrunnlag</button>`);
